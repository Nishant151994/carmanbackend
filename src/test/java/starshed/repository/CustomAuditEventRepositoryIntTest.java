...
import starshed.config.audit.AuditEventConverter;
import starshed.domain.PersistentAuditEvent;
...
import static starshed.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
